...
```
* Mean: `r step_day_mean`
* Median:  `r step_day_median`
...
* Most Steps at: `r most_steps_time`
...
```
* Mean (Imputed): `r step_day_imputed_mean`
* Median (Imputed):  `r step_day_imputed_median`
